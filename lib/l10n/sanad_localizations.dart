...
import 'sanad_localizations_ar.dart' deferred as sanad_localizations_ar;
import 'sanad_localizations_en.dart' deferred as sanad_localizations_en;
...
///
/// ```dart
/// import 'l10n/sanad_localizations.dart';
///
/// return MaterialApp(
...
abstract class SL {
  ...
  /// No description provided for @sanad.
  ///
  ...
  /// No description provided for @uploadStatusFail.
  ///
  /// In en, this message translates to:
  /// **'fail'**
  String get uploadStatusFail;
  ...
  /// No description provided for @permissionsBodyCamera.
  ///
  /// In en, this message translates to:
  /// **'allow the app to use the camera'**
  String get permissionsBodyCamera;

  /// No description provided for @permissionsBodyGallery.
  ///
  /// In en, this message translates to:
  /// **'allow the app to use the gallery'**
  String get permissionsBodyGallery;

  /// No description provided for @authLoginFailer.
  ///
  /// In en, this message translates to:
  /// **'invalid credintials'**
  String get authLoginFailer;

  /// No description provided for @taskPageUploaddialogConfirmation.
  ///
  /// In en, this message translates to:
  /// **'Are you sure you want to close the task now ?'**
  String get taskPageUploaddialogConfirmation;

  /// No description provided for @taskPageUploadTitle.
  ///
  /// In en, this message translates to:
  /// **'Upload'**
  String get taskPageUploadTitle;

  /// No description provided for @taskPageDataTitle.
  ///
  /// In en, this message translates to:
  /// **'Data'**
  String get taskPageDataTitle;

  /// No description provided for @taskPagePhotosTitle.
  ///
  /// In en, this message translates to:
  /// **'Pictures'**
  String get taskPagePhotosTitle;

  /// No description provided for @deleteLocalTaskTitle.
  ///
  /// In en, this message translates to:
  /// **'Cancel the Task'**
  String get deleteLocalTaskTitle;

  /// No description provided for @deleteLocalTaskMsg.
  ///
  /// In en, this message translates to:
  /// **'Are you sure, you want to cancel this task?'**
  String get deleteLocalTaskMsg;

  /// No description provided for @archiveTeasksClosed.
  ///
  /// In en, this message translates to:
  /// **'Done'**
  String get archiveTeasksClosed;

  /// No description provided for @archiveTasksWaiting.
  ///
  /// In en, this message translates to:
  /// **'Waitting'**
  String get archiveTasksWaiting;

  /// No description provided for @bottomNavLocalTasks.
  ///
  /// In en, this message translates to:
  /// **'Saved'**
  String get bottomNavLocalTasks;

  /// No description provided for @bottomNavOnlineTasks.
  ///
  /// In en, this message translates to:
  /// **'Tasks'**
  String get bottomNavOnlineTasks;
  ...
  ///
  /// In en, this message translates to:
  /// **'Log out will destroy all data saved in your phone, are you sure you want to continue?'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Complete delete of the account from the company server !!'**
  String get deleteAccountMessage;

  /// No description provided for @deleteAccountMessage2.
  ///
  /// In en, this message translates to:
  /// **'You can not redo this operation !!, are you sure?'**
  ...
  /// No description provided for @theCompany.
  ///
  /// In en, this message translates to:
  /// **'the Company'**
  String get theCompany;

  /// No description provided for @theCompanyNameLabel.
  ///
  /// In en, this message translates to:
  /// **'the company name'**
  String get theCompanyNameLabel;
  ...
  /// No description provided for @userdetailsInfoTitle.
  ///
  /// In en, this message translates to:
  /// **'details'**
  String get userdetailsInfoTitle;

  /// No description provided for @userdetailsEditLabelText.
  ///
  /// In en, this message translates to:
  /// **'edit'**
  String get userdetailsEditLabelText;

  /// No description provided for @userdetailsCompanyLabel.
  ///
  /// In en, this message translates to:
  /// **'companies'**
  String get userdetailsCompanyLabel;

  /// No description provided for @taskPricingPriceValidator.
  ///
  /// In en, this message translates to:
  /// **'price is required'**
  String get taskPricingPriceValidator;

  /// No description provided for @taskPricingAreaValidator.
  ///
  /// In en, this message translates to:
  /// **'area is required'**
  String get taskPricingAreaValidator;

  /// No description provided for @taskPricingName.
  ///
  /// In en, this message translates to:
  /// **'name'**
  String get taskPricingName;

  /// No description provided for @taskPricingMeterArea.
  ///
  /// In en, this message translates to:
  /// **'area'**
  String get taskPricingMeterArea;

  /// No description provided for @taskPricingMeterArea2.
  ///
  /// In en, this message translates to:
  /// **'M2'**
  String get taskPricingMeterArea2;

  /// No description provided for @taskPricingMeterPrice.
  ///
  /// In en, this message translates to:
  /// **'price'**
  String get taskPricingMeterPrice;

  /// No description provided for @taskPricingMeterPrice2.
  ///
  /// In en, this message translates to:
  /// **'K'**
  String get taskPricingMeterPrice2;

  /// No description provided for @taskPricingTotalPrice.
  ///
  /// In en, this message translates to:
  /// **'total price'**
  String get taskPricingTotalPrice;

  /// No description provided for @taskPricingTotalPrice2.
  ///
  /// In en, this message translates to:
  /// **'K/m2'**
  String get taskPricingTotalPrice2;

  /// No description provided for @taskPricingReal.
  ///
  /// In en, this message translates to:
  /// **'RS'**
  String get taskPricingReal;

  /// No description provided for @taskPricingK.
  ///
  /// In en, this message translates to:
  /// **'K'**
  String get taskPricingK;

  /// No description provided for @taskPricingMeter.
  ///
  /// In en, this message translates to:
  /// **'M'**
  String get taskPricingMeter;

  /// No description provided for @taskPricingMeterSquare.
  ///
  /// In en, this message translates to:
  /// **'M2'**
  String get taskPricingMeterSquare;
  ...
  /// No description provided for @homeTasksTitle.
  ///
  /// In en, this message translates to:
  /// **'Tasks'**
  String get homeTasksTitle;
  ...
  /// No description provided for @theLogin.
  ///
  /// In en, this message translates to:
  /// **'login'**
  String get theLogin;
...
Future<SL> lookupSL(Locale locale) {
  // Lookup logic when only language code is specified.
  switch (locale.languageCode) {
    case 'ar':
      return sanad_localizations_ar
          .loadLibrary()
          .then((dynamic _) => sanad_localizations_ar.SLAr());
    case 'en':
      return sanad_localizations_en
          .loadLibrary()
          .then((dynamic _) => sanad_localizations_en.SLEn());
  }
